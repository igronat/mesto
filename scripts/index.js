...
const formProfile = new FormValidator(enableValidation, updateProfile);
const formNewMesto = new FormValidator(enableValidation, updateMesto);
formProfile.enableValidation();
formNewMesto.enableValidation();
